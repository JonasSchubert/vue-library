...
import AppBarBtn from './app-bar-btn/app-bar-btn.vue';
import AppBarMenu from './app-bar-menu/app-bar-menu.vue';
import AppContent from './app-content/app-content.vue';
...
export const controls = [AppBar, AppBarBtn, AppBarMenu, AppContent, AppFooter, AppLocaleChooser, AppSnackbar, AudioPlayer, DinosaurGame];
