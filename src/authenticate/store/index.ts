...
export const createAuthenticateModule = <TRootState, T extends LoginResponse>({
  cookieKeyAuthenticationToken,
  customGetters,
  daysTilExpiredAuthenticationCookie
}: AuthenticateModuleSetup<TRootState, T>): Module<AuthenticateState<T>, TRootState> => ({
    namespaced: true,
