...
describe('AppFooter', () => {
  test('renders as expected', () => {
    // Assert
    expect(getMountedComponent(AppFooter, { version: '20.05.01-0' }).html()).toBe(`<v-footer-stub color=\"secondary\" height=\"auto\" dark=\"true\" tag=\"div\" tile=\"true\" app=\"true\" dense=\"\">
