...
describe('AppBar', () => {
  test('renders correctly with different props', () => {
    // Assert
    expect(getMountedComponent(AppBar, { isAnythingLoading: true }).html()).toBe(`<v-app-bar-stub elevation="2" tag="header" tile="true" dense="true" extensionheight="48" src="" value="true" app="true" clippedleft="true" clippedright="true">
  ...
  <v-progress-linear-stub color="accent" absolute="true" bottom="true" value="0" active="true" buffervalue="100" height="4" indeterminate="true"></v-progress-linear-stub>
    ...
    expect(getMountedComponent(AppBar, { isAnythingLoading: false }).html()).toBe(`<v-app-bar-stub elevation="2" tag=\"header\" tile=\"true\" dense=\"true\" extensionheight=\"48\" src=\"\" value=\"true\" app=\"true\" clippedleft="true" clippedright="true">
  <v-spacer-stub></v-spacer-stub>
  <app-locale-chooser></app-locale-chooser>
